...
func SendSms(c *gin.Context) {
	...
	request.QueryParams["SignName"] = "qwer"                            //阿里云验证过的项目名 自己设置
	...
	rdb.Set(context.Background(), sendSmsForm.Mobile, smsCode, time.Minute*time.Duration(global.ServerConfig.RedisInfo.Expire))
